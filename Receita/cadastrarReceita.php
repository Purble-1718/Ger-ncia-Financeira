...
$sql = "INSERT INTO Receita (descricao, valor, data_mvto, status_pago, categoria_id) VALUES #Digita isso primeiro para habilitar campos que vão receber valores pelo bindValue.
        (:descricao, :valor, :data_mvto, :status_pago, :categoria_id)"; #variável com código de MySQL
